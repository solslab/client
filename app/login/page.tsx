...
export default function Page() {
	return (
		<div className="relative flex min-h-screen flex-col items-center justify-center py-24">
			<Float />
			<div className="absolute h-full w-full bg-white bg-opacity-65 backdrop-blur-sm">
					...
					<div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
						<div className="flex justify-center items-center">
							<Link
								...
								className=" "
							>
                <div className='bg-kakao flex px-6 py-2 rounded-md text-sm font-semibold text-black shadow-sm'>
                  <div className='flex'>
