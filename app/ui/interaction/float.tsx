...
export default function Float() {
	return (
		<div className="absolute left-0 top-0 hidden h-full w-full overflow-hidden sm:block">
			<div className="absolute left-0 top-7/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-14/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-8/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-6/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-17/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-9/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-12/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-13/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-16/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-10/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-4/20 w-full">
				<Image
			...
			<div className="absolute left-0 top-15/20 w-full">
				<Image
