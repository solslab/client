          ...
          <CardHeader className="flex items-center">
            <div className="ml-auto flex gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => setIsCompanyUpdateModalOpen(true)}
              >
                <FileEdit size={16} />
              </Button>
            ...
            <div className="flex w-full flex-col gap-2 p-4">
              ...
              {companyDetail.positions.map((position, index) => (
                <div key={index} className="flex items-center justify-between">
                  <Button
                    className="mb-2 w-full p-5 text-left"
                    onClick={() => {
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setTestInfoIdToDelete(position.position_id); // 삭제할 시험정보 ID 저장
                      setIsDeleteTestConfirmOpen(true); // 시험정보 삭제 확인창 열기
                    }}
                  >
                    <LucideTrash size={16} />
                  </Button>
